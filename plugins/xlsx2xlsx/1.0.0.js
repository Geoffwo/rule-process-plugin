    ...
    return jsonData.map(item => {
        ...
        item.data.forEach(dataItem=>{
            ...
            params.tg_data.GF_KH_DATA.forEach(param=>{
                ...
                // paramObj['类型']='光伏'
                paramObj['入参-有功负荷']=param.ACTIVE_POWER_DATA_VALUE
                ...
                paramObj['光伏有功-当前负荷削减系数'] = findResult.ACTIVE_POWER_DATA_VALUE
                ...
                paramObj['装机容量有功调节-调节系数'] =  paramObj['入参-有功负荷']*(1-paramObj['光伏有功-当前负荷削减系数'])/paramObj['装机容量'];
                paramObj['发电效率'] = paramObj['入参-有功负荷']/paramObj['装机容量'];
            ...
            // paramObj['C相电压(V)']='/'
            // paramObj['类型']='台区'
            // paramObj['入参-有功负荷']=params.tg_data.FH_KH_DATA.ACTIVE_POWER_DATA_VALUE
            // paramObj['入参-无功负荷']=''
            // paramObj['入参-发电效率']=params.tg_data.TG__GATE_LOAD_RATE
            // map.push(paramObj)
        });
...
module.exports = {
    ...
    description:'主要用于将xlsx文件转化为xlsx-特定泰安数据处理',
    notes:{
        node:'18.20.4',
    },
    input: {

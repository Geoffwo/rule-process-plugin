        ...
        "steps": [
            ...
            },
            {
                ...
                "actions": [
                    ...
                    { "input": "input[name='item_code']", "value": "{{reportName}}" },
                    { "waitMs": 1000 },
...
module.exports = {
    ...
    description: 'Excel驱动puppeteer自动化；双键(ctxKey/tabKey)驱动会话隔离与标签页复用；once成功后跳过、iframe穿透；迭代器实时导出；getData采集、fetchApi浏览器上下文请求、json2xlsx转换、exportData多格式导出',
    notes: {
        node: '>=18.0.0',
        tips: `
【核心机制说明】

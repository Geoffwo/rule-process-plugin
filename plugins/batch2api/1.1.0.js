...
async function writingRules(inputArray, outputNodeTemplate) {
  ...
  const { url, method, headers, bodyTemplate, delay = 200, passwordEncrypt = [] } = config;
...
module.exports = {
  ...
  description: 'RAGFLOW定制-读取 Excel 数据，按配置模板循环调用 HTTP 接口，批量新增数据（支持RSA密码加密）',
  notes: {
    node: '18.20.4'
  },
  input: {
